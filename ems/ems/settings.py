...
DATABASES = {
    'default': {
        ...
        'NAME': 'myEMSprojectdb',                        # apna database name (Workbench me create karo)
        'USER': 'root',                         # apna MySQL username
        'PASSWORD': 'Newmysql@2025#',             # apna MySQL password
...
#         'NAME': str(BASE_DIR / 'db.sqlite3'),   # ✅ Path को string में convert किया
#     }
# }
